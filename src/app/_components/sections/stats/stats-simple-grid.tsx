          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Drive Your Dreams: Premium Car Rentals at Your Fingertips
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience the Ultimate in Comfort, Style, and Convenience with Our Professional Car Rental Services
              </p>
            </div>
